...
class UsersController extends AppController
{
     ...
     * @return \Cake\Http\Response|null|void
     */
    public function attendances($id = null)
    {
        $user = $this->Users->get($id, ['contain' => ['Companies']]);
        ...
        $attendanceStats = $this->_getUserAttendanceStats($id, $filters);
     ...
     * @return array
     */
    private function _getSpecificUserStats($user): array
    {
        $Attendances = $this->getTable('JornaticCore.Attendances');
        $Absences = $this->getTable('JornaticCore.Absences');
     ...
     * @return array
     */
    private function _getUserAttendanceStats($userId, $filters = []): array
    {
        $Attendances = $this->getTable('JornaticCore.Attendances');
